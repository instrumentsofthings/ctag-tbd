...
atomic<int32_t> waveform, cv_waveform;
atomic<int32_t> octave, cv_octave;
atomic<int32_t> tune, cv_tune;
atomic<int32_t> pwm, cv_pwm;
atomic<int32_t> mod_pitch1, cv_mod_pitch1;
atomic<int32_t> mod_pitch2, cv_mod_pitch2;
atomic<int32_t> mod_fm, cv_mod_fm;
atomic<int32_t> mod_pwm, cv_mod_pwm;
// sectionHpp
